...
namespace SacramentMeetingPlanner.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id, Date, Leader, OpeningSong, OpeningPrayer, SacramentHymn, MusicNumber, ClosingSong, ClosingPrayer")] Meeting meeting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id, Date, Leader, OpeningSong, OpeningPrayer, SacramentHymn, MusicNumber, ClosingSong, ClosingPrayer")] Meeting meeting)
        {
            if (id != meeting.Id)
            {
                return NotFound();
